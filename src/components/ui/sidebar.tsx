  ...
  (
    ...
    return (
      ...
      >
        ...
        {/* made this hidden as sidebar should come on top of content */}
        <div
          className={cn(
        ...
        />
        <div
        // h-svh inset-y-0 added top-20 and h-full instead
          className={cn(
            "duration-200 fixed top-16 h-[calc(100svh-4rem)] z-10 hidden w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
