	...
	(options: DateTimeInputProps, ref) => {
		...
		return (
			<div
				ref={ref}
				className={cn(
					"relative z-0 flex h-10 items-end justify-between rounded-none bg-background text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 border-0 border-b border-gray-300",
					isFocused
						? "outline-none ring-0"
						: "",
			...
			>
                ...
                //pe-2
					...
					className="font-mono flex-grow min-w-0 text-sm block py-1.5 px-0 w-full shadow-sm transition-colors duration-300 text-gray-900 bg-transparent appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer disabled:opacity-50 disabled:cursor-not-allowed"
