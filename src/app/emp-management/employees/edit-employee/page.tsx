...
import BasicInformation from "../add-employee/BasicInformation";
import BankDetails from "../add-employee/BankDetails";
import Documents from "../add-employee/Documents";
import Statutory from "../add-employee/Statutory";
import Statements from "../add-employee/Statements";
	...
	return (
		<div className="w-full flex gap-4 h-full">
			...
			<ScrollArea className="flex-1 h-[calc(100vh-4rem)] max-h-[calc(100vh-4rem)] flex p-4">
              ...
              <Button type="button" onClick={() => router.push("/emp-management/employees/emp-change-pin")}>
								<Save />
								Change Pin
							</Button>
              <Button type="submit">
