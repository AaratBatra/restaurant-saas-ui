...
import BasicInformation from "@/app/emp-management/employees/view-employee/BasicInformation";
import BankDetails from "@/app/emp-management/employees/view-employee/BankDetails";
import Documents from "@/app/emp-management/employees/view-employee/Documents";
import Statutory from "@/app/emp-management/employees/view-employee/Statutory";
import Statements from "@/app/emp-management/employees/view-employee/Statements";
import Shifts from "@/app/emp-management/employees/edit-employee/Shifts";
...
const ViewEmployee = () => {
	...
	return (
		<div className="w-full flex gap-4 h-full">
			<div className="h-full flex-grow-0 flex-shrink-0 basis-40 flex flex-col gap-2 shadow-md">
				...
				<Form {...form}>
					...
					>
						<div className="w-full flex items-center justify-between">
							<h1 className="text-[#222b45]">Profile</h1>
